...
public class WorkshopInfrastructure {
	...
	private List<String> teamIdentifiers = Lists.newArrayList();
	...
	public WorkshopInfrastructure withTeamIdentifiers(
	...
	public WorkshopInfrastructure withBeanstalkNotificationEmail(
	...
	public int getNumberOfServersPerTeam() {
		return 2;
	}
}
