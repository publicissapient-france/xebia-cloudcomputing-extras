    ...
    public void generateDocs(WorkshopInfrastructure workshopInfrastructure, String baseWikiFolder) throws IOException {
        ...
        for (String teamIdentifier : new TreeSet<String>(workshopInfrastructure.getTeamIdentifiers())) {
            indexPageWriter.println(
                    ...
                    "(https://github.com/xebia-france/flume-hadoop-workshop/wiki/" + wikiPageNamesByTeamIdentifier.get(teamIdentifier) + ")");
        }
        ...
        System.out.println("All the files in " + baseWikiFolder + " must be committed in https://github.com/xebia-france/flume-hadoop-workshop/wiki/");
